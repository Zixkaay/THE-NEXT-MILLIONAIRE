...
export const INITIAL_PARTICIPANTS = [
  {
    id: 'p1', full_name: 'Kwame Osei', nickname: 'TechKwame', status: 'Approved', ranking: 1, vote_count: 54320, media_urls: { images: ['https://images.unsplash.com/photo-1543807535-ecefc092c2da?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Pioneering AI-driven logistics for rural farmers in Ghana. Visionary leader aiming to digitize the agricultural supply chain from farm to market.', metadata: { Industry: 'AgriTech', Experience: '5 Years', Location: 'Accra, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  },
  {
    id: 'p2', full_name: 'Ama Mensah', nickname: 'AmaInnovates', status: 'Approved', ranking: 2, vote_count: 42100, media_urls: { images: ['https://images.unsplash.com/photo-1531123897727-8f129e1608ce?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Founder of a sustainable fashion brand utilizing recycled textiles from Kantamanto market to create high-end streetwear.', metadata: { Industry: 'Fashion', Experience: '3 Years', Location: 'Kumasi, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  },
  {
    id: 'p3', full_name: 'Yaw Boakye', nickname: 'YawFin', status: 'Approved', ranking: 3, vote_count: 39500, media_urls: { images: ['https://images.unsplash.com/photo-1506803682981-6e718a9dd3ee?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Democratizing access to credit for micro-SMEs across Accra through decentralized finance and mobile money rails.', metadata: { Industry: 'FinTech', Experience: '4 Years', Location: 'Accra, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  },
  {
    id: 'p4', full_name: 'Akosua Serwaa', nickname: 'KokoBuilds', status: 'Approved', ranking: null, vote_count: 21000, media_urls: { images: ['https://images.unsplash.com/photo-1531384441138-2736e62e0919?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Building eco-friendly, affordable housing using locally sourced laterite and bamboo composites.', metadata: { Industry: 'Real Estate', Experience: '6 Years', Location: 'Tamale, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  },
  {
    id: 'p5', full_name: 'Kofi Annan Jr.', nickname: 'KofiTech', status: 'Approved', ranking: null, vote_count: 15400, media_urls: { images: ['https://images.unsplash.com/photo-1552699611-e2c208d538f1?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Creating robust e-learning platforms tailored for Ghanaian curriculums, making education accessible in remote areas.', metadata: { Industry: 'EdTech', Experience: '2 Years', Location: 'Cape Coast, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  },
  {
    id: 'p6', full_name: 'Esi Ofori', nickname: 'EsiHealth', status: 'Evicted', ranking: null, vote_count: 8200, media_urls: { images: ['https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=1000&auto=format&fit=crop'], videos: [] }, bio: 'Focused on deploying mobile health clinics focused on maternal care across the coastal regions.', metadata: { Industry: 'HealthTech', Experience: '4 Years', Location: 'Takoradi, Ghana' }, created_at: new Date().toISOString(), updated_at: new Date().toISOString()
  }
];
